...
To complete this lab you will utilize JupyterLab running on the Cloud in Skills Network Labs environment. To launch the lab notebook in a new browser tab check the box below and click on the Open Tool button.  
